...
BEGIN
{
  ...
  $postmaster        = '';
  @referers          = qw(maisonducoin.com www.maisonducoin.com localhost);
  @allow_mail_to     = qw(maisonducoin.com www.maisonducoin.com localhost);
  @recipients        = ();
  %recipient_alias   = ();
...
From: shideh@maisonducoin.com
Subject: Thank You - maisonducoin.com

Thank you for providing your contact information to Maison Du Coin.
